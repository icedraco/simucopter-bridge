...
namespace SIMUCOPTER {
    ...
    public:
        ...
        BridgeClient(
                ...
                m_serializer(),
                m_context(SIMUCOPTER::ZMQ_NUM_THREADS),
                m_socket_requests(m_context, ZMQ_REQ),
                m_socket_cmdTransmit(m_context, ZMQ_PUB) {}
         ...
         */
        void send_command(int msgid, double arg1);
         ...
         */
        void send_command(int msgid, double arg1, double arg2);
    ...
    private:
        ...
        zmq::socket_t m_socket_cmdTransmit;
    };
