...
ln -vs "simucopter/control_simulink.cpp" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/simucopter-arducopter.cpp" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/simucopter-arducopter.h" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/SimuCopterMessage.h" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/ArduCopterCommandHandler.cpp" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/ArduCopterCommandHandler.h" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/ArduCopterRequestHandler.cpp" "${ARDUPILOT_ROOT}/ArduCopter/"
ln -vs "simucopter/ArduCopterRequestHandler.h" "${ARDUPILOT_ROOT}/ArduCopter/"

echo "      > general bridge library"
ln -vs "bridge" "${ARDUPILOT_ROOT}/libraries/bridge"
